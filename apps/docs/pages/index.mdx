...
- **Designed for SPAs**: Tailored specifically for Single Page Applications, our plugin addresses the unique challenges they present. Please note that Multi Page Applications (MPAs) are not supported due to their architectural differences.
...
<Cards>
  <Card title="SPA Guide" href="/guides/spa" />
</Cards>

## Why We Stand Out

- **Up-to-Date and Reliable**: The only alternative on the market is outdated and unreliable. Our plugin is actively maintained to ensure compatibility with the latest Vite updates and security practices.
- **Community and Support**: Join a growing community of developers who trust and use Vite Plugin Hash CSP. Get help and share your experiences on our support forums.
